...
import { selectProfile, selectCurrent, selectStatus, getProfileAsync, updateAsync } from '../../app/authSlice';
            ...
            { user && user.isActive && profile &&
                <div className="text-white" style={{ maxWidth: '720px', margin: '0 auto' }}>
                    ...
                    <Row className="p-2 border-bottom ms-2 me-2 userprofile-table__row">
                        ...
                        <Col sm="12" md="8">
                            <EditableCell value={ values.firstName.value } editMode={ editMode } onInput={ value => setValue("firstName", value) } />
                        </Col>
                    </Row>
                    ...
                    <Row className="p-2 border-bottom ms-2 me-2 userprofile-table__row">
                        ...
                        <Col sm="12" md="8">
                            <EditableCell value={ values.secondName.value } editMode={ editMode } onInput={ value => setValue("secondName", value) } />
                        </Col>
                    </Row>
                    ...
                    <Row className="p-2 border-bottom ms-2 me-2 userprofile-table__row">
                        ...
                        <Col sm="12" md="8">
                            <EditableCell value={ values.lastName.value } editMode={ editMode } onInput={ value => setValue("lastName", value) } />
                        </Col>
                    </Row>
                    ...
                    <Row className="p-2 border-bottom ms-2 me-2 userprofile-table__row">
                        ...
                        <Col sm="12" md="8">
                            <EditableCell value={ values.phoneNumber.value } editMode={ editMode } onInput={ value => setValue("phone", value) } validationRule={ validatePhone } validationErrorText='Формат: 0123456789' />
                        </Col>
                    </Row>
                    ...
                    <Row className="p-2 border-bottom ms-2 me-2 userprofile-table__row">
                        ...
                        <Col sm="12" md="8">
                            <EditableCell value={ values.email.value } editMode={ editMode } onInput={ value => setValue("email", value) } validationRule={ validation.notEmptyValidationRule } validationErrorText="Обов’язкове поле" />
                        </Col>
                    </Row>
                    ...
                    <Row className="m-3">
                        <Col>
                            { editMode ? 
                                <div>
                                    <Button className="me-2" disabled={ !isValid } onClick={ update }>Зберегти</Button>
