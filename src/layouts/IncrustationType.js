...
const IncrustationType = () => {
    return (
        <PropertyTable title="Інкрустація" selectValues={ selectValues } selectStatus={ selectStatus } get={ getAsync } update={ updateAsync } create={ createAsync} remove={ deleteAsync } />
    );
}
