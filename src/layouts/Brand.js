...
const Brand = () => {
    return (
        <BrandPropertyTable title="Виробник" selectValues={ selectValues } selectStatus={ selectStatus } get={ getAsync } update={ updateAsync } create={ createAsync} remove={ deleteAsync } />
    );
}
